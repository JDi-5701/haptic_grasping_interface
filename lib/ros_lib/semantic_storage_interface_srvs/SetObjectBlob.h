#ifndef _ROS_SERVICE_SetObjectBlob_h
#define _ROS_SERVICE_SetObjectBlob_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETOBJECTBLOB[] = "semantic_storage_interface_srvs/SetObjectBlob";

  class SetObjectBlobRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SETOBJECTBLOB; };
    virtual const char * getMD5() override { return "20704246bbbc381fa1dab5d83931e8ee"; };

  };

  class SetObjectBlobResponse : public ros::Msg
  {
    public:
  ...
  class SetObjectBlob {
    public:
    typedef SetObjectBlobRequest Request;
    typedef SetObjectBlobResponse Response;
  };
