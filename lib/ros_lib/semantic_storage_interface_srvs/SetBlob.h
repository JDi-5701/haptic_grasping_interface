#ifndef _ROS_SERVICE_SetBlob_h
#define _ROS_SERVICE_SetBlob_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETBLOB[] = "semantic_storage_interface_srvs/SetBlob";

  class SetBlobRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SETBLOB; };
    virtual const char * getMD5() override { return "20704246bbbc381fa1dab5d83931e8ee"; };

  };

  class SetBlobResponse : public ros::Msg
  {
    public:
  ...
  class SetBlob {
    public:
    typedef SetBlobRequest Request;
    typedef SetBlobResponse Response;
  };
