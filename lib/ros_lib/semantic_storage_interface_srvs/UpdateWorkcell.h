#ifndef _ROS_SERVICE_UpdateWorkcell_h
#define _ROS_SERVICE_UpdateWorkcell_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char UPDATEWORKCELL[] = "semantic_storage_interface_srvs/UpdateWorkcell";

  class UpdateWorkcellRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return UPDATEWORKCELL; };
    virtual const char * getMD5() override { return "d5d54b79a0881f8327f27afcd7196331"; };

  };

  class UpdateWorkcellResponse : public ros::Msg
  {
    public:
  ...
  class UpdateWorkcell {
    public:
    typedef UpdateWorkcellRequest Request;
    typedef UpdateWorkcellResponse Response;
  };
