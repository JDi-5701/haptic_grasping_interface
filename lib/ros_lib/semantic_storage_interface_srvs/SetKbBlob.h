#ifndef _ROS_SERVICE_SetKbBlob_h
#define _ROS_SERVICE_SetKbBlob_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETKBBLOB[] = "semantic_storage_interface_srvs/SetKbBlob";

  class SetKbBlobRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SETKBBLOB; };
    virtual const char * getMD5() override { return "20704246bbbc381fa1dab5d83931e8ee"; };

  };

  class SetKbBlobResponse : public ros::Msg
  {
    public:
  ...
  class SetKbBlob {
    public:
    typedef SetKbBlobRequest Request;
    typedef SetKbBlobResponse Response;
  };
