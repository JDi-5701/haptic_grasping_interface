#ifndef _ROS_SERVICE_SetWorkcellBlob_h
#define _ROS_SERVICE_SetWorkcellBlob_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETWORKCELLBLOB[] = "semantic_storage_interface_srvs/SetWorkcellBlob";

  class SetWorkcellBlobRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SETWORKCELLBLOB; };
    virtual const char * getMD5() override { return "20704246bbbc381fa1dab5d83931e8ee"; };

  };

  class SetWorkcellBlobResponse : public ros::Msg
  {
    public:
  ...
  class SetWorkcellBlob {
    public:
    typedef SetWorkcellBlobRequest Request;
    typedef SetWorkcellBlobResponse Response;
  };
