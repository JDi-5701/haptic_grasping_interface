#ifndef _ROS_SERVICE_QueryPlans_h
#define _ROS_SERVICE_QueryPlans_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char QUERYPLANS[] = "semantic_storage_interface_srvs/QueryPlans";

  class QueryPlansRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return QUERYPLANS; };
    virtual const char * getMD5() override { return "3f2a621ad2420da4e5912f9f0d6ce8f2"; };

  };

  class QueryPlansResponse : public ros::Msg
  {
    public:
  ...
  class QueryPlans {
    public:
    typedef QueryPlansRequest Request;
    typedef QueryPlansResponse Response;
  };
