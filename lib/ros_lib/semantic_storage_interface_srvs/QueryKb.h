#ifndef _ROS_SERVICE_QueryKb_h
#define _ROS_SERVICE_QueryKb_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char QUERYKB[] = "semantic_storage_interface_srvs/QueryKb";

  class QueryKbRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return QUERYKB; };
    virtual const char * getMD5() override { return "3f2a621ad2420da4e5912f9f0d6ce8f2"; };

  };

  class QueryKbResponse : public ros::Msg
  {
    public:
  ...
  class QueryKb {
    public:
    typedef QueryKbRequest Request;
    typedef QueryKbResponse Response;
  };
