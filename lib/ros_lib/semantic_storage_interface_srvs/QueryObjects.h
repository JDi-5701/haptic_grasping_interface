#ifndef _ROS_SERVICE_QueryObjects_h
#define _ROS_SERVICE_QueryObjects_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char QUERYOBJECTS[] = "semantic_storage_interface_srvs/QueryObjects";

  class QueryObjectsRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return QUERYOBJECTS; };
    virtual const char * getMD5() override { return "3f2a621ad2420da4e5912f9f0d6ce8f2"; };

  };

  class QueryObjectsResponse : public ros::Msg
  {
    public:
