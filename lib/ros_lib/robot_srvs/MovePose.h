#ifndef _ROS_SERVICE_MovePose_h
#define _ROS_SERVICE_MovePose_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char MOVEPOSE[] = "robot_srvs/MovePose";

  class MovePoseRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return MOVEPOSE; };
    virtual const char * getMD5() override { return "fee670b84c195f8a24a76ee01f1c25b0"; };

  };

  class MovePoseResponse : public ros::Msg
  {
    public:
      uint32_t q_length;
