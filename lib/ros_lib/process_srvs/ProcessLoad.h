#ifndef _ROS_SERVICE_ProcessLoad_h
#define _ROS_SERVICE_ProcessLoad_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char PROCESSLOAD[] = "process_srvs/ProcessLoad";

  class ProcessLoadRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return PROCESSLOAD; };
    virtual const char * getMD5() override { return "a3b9c4d6755e03b461791903d7edafb4"; };

  };

  class ProcessLoadResponse : public ros::Msg
  {
    public:
  ...
  class ProcessLoad {
    public:
    typedef ProcessLoadRequest Request;
    typedef ProcessLoadResponse Response;
  };
