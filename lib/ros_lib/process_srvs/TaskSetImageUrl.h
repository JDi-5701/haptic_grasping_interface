#ifndef _ROS_SERVICE_TaskSetImageUrl_h
#define _ROS_SERVICE_TaskSetImageUrl_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char TASKSETIMAGEURL[] = "process_srvs/TaskSetImageUrl";

  class TaskSetImageUrlRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return TASKSETIMAGEURL; };
    virtual const char * getMD5() override { return "aebfb9f86f726d5b1814293472b8c2b1"; };

  };

  class TaskSetImageUrlResponse : public ros::Msg
  {
    public:
      typedef middleware_msgs::Status _status_type;
      _status_type status;

    TaskSetImageUrlResponse():
      status()
    {
    }
  ...
  class TaskSetImageUrl {
    public:
    typedef TaskSetImageUrlRequest Request;
    typedef TaskSetImageUrlResponse Response;
  };
