#ifndef _ROS_SERVICE_PhysicalEntityDelete_h
#define _ROS_SERVICE_PhysicalEntityDelete_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char PHYSICALENTITYDELETE[] = "process_srvs/PhysicalEntityDelete";

  class PhysicalEntityDeleteRequest : public ros::Msg
  {
    public:
      typedef const char* _iri_type;
      _iri_type iri;

    PhysicalEntityDeleteRequest():
      iri("")
    {
    }
    ...
    virtual const char * getType() override { return PHYSICALENTITYDELETE; };
    virtual const char * getMD5() override { return "a3b9c4d6755e03b461791903d7edafb4"; };

  };

  class PhysicalEntityDeleteResponse : public ros::Msg
  {
    public:
      typedef middleware_msgs::Status _status_type;
      _status_type status;

    PhysicalEntityDeleteResponse():
      status()
    {
    }
  ...
  class PhysicalEntityDelete {
    public:
    typedef PhysicalEntityDeleteRequest Request;
    typedef PhysicalEntityDeleteResponse Response;
  };
