#ifndef _ROS_SERVICE_ProcessSetName_h
#define _ROS_SERVICE_ProcessSetName_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char PROCESSSETNAME[] = "process_srvs/ProcessSetName";

  class ProcessSetNameRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return PROCESSSETNAME; };
    virtual const char * getMD5() override { return "c46e2285a1beca718f1adc3f5d1a245d"; };

  };

  class ProcessSetNameResponse : public ros::Msg
  {
    public:
  ...
  class ProcessSetName {
    public:
    typedef ProcessSetNameRequest Request;
    typedef ProcessSetNameResponse Response;
  };
