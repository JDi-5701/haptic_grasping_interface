#ifndef _ROS_SERVICE_ProcessSetDescription_h
#define _ROS_SERVICE_ProcessSetDescription_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char PROCESSSETDESCRIPTION[] = "process_srvs/ProcessSetDescription";

  class ProcessSetDescriptionRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return PROCESSSETDESCRIPTION; };
    virtual const char * getMD5() override { return "10e9440cdd4657ebd3503450a59b9b26"; };

  };

  class ProcessSetDescriptionResponse : public ros::Msg
  {
    public:
      typedef middleware_msgs::Status _status_type;
      _status_type status;

    ProcessSetDescriptionResponse():
      status()
    {
    }
  ...
  class ProcessSetDescription {
    public:
    typedef ProcessSetDescriptionRequest Request;
    typedef ProcessSetDescriptionResponse Response;
  };
