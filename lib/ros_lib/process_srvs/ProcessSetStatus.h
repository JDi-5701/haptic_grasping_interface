#ifndef _ROS_SERVICE_ProcessSetStatus_h
#define _ROS_SERVICE_ProcessSetStatus_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char PROCESSSETSTATUS[] = "process_srvs/ProcessSetStatus";

  class ProcessSetStatusRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return PROCESSSETSTATUS; };
    virtual const char * getMD5() override { return "3d0226e2252745ca0820413850b56428"; };

  };

  class ProcessSetStatusResponse : public ros::Msg
  {
    public:
      typedef middleware_msgs::Status _status_type;
      _status_type status;

    ProcessSetStatusResponse():
      status()
    {
    }
  ...
  class ProcessSetStatus {
    public:
    typedef ProcessSetStatusRequest Request;
    typedef ProcessSetStatusResponse Response;
  };
