#ifndef _ROS_SERVICE_ProcessDelete_h
#define _ROS_SERVICE_ProcessDelete_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char PROCESSDELETE[] = "process_srvs/ProcessDelete";

  class ProcessDeleteRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return PROCESSDELETE; };
    virtual const char * getMD5() override { return "a3b9c4d6755e03b461791903d7edafb4"; };

  };

  class ProcessDeleteResponse : public ros::Msg
  {
    public:
  ...
  class ProcessDelete {
    public:
    typedef ProcessDeleteRequest Request;
    typedef ProcessDeleteResponse Response;
  };
