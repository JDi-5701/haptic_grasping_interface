#ifndef _ROS_SERVICE_ProcessSetCurrentSubtask_h
#define _ROS_SERVICE_ProcessSetCurrentSubtask_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char PROCESSSETCURRENTSUBTASK[] = "process_srvs/ProcessSetCurrentSubtask";

  class ProcessSetCurrentSubtaskRequest : public ros::Msg
  {
    public:
    ...
    ProcessSetCurrentSubtaskRequest():
      iri(""),
      currentSubtaskIri(""),
      publish(0)
    {
    ...
    virtual const char * getType() override { return PROCESSSETCURRENTSUBTASK; };
    virtual const char * getMD5() override { return "76d33c75d798496b984294d86eb0724c"; };

  };

  class ProcessSetCurrentSubtaskResponse : public ros::Msg
  {
    public:
      typedef middleware_msgs::Status _status_type;
      _status_type status;

    ProcessSetCurrentSubtaskResponse():
      status()
    {
    }
  ...
  class ProcessSetCurrentSubtask {
    public:
    typedef ProcessSetCurrentSubtaskRequest Request;
    typedef ProcessSetCurrentSubtaskResponse Response;
  };
