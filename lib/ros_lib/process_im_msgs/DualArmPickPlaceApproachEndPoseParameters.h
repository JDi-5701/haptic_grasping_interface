#ifndef _ROS_process_im_msgs_DualArmPickPlaceApproachEndPoseParameters_h
#define _ROS_process_im_msgs_DualArmPickPlaceApproachEndPoseParameters_h
...
namespace process_im_msgs
{
  ...
  class DualArmPickPlaceApproachEndPoseParameters : public ros::Msg
  {
    public:
      ...
      typedef geometry_msgs::Pose _placeobject_sync_type;
      _placeobject_sync_type placeobject_sync;
      typedef geometry_msgs::Pose _place_execution_actor_resting_type;
      _place_execution_actor_resting_type place_execution_actor_resting;
    ...
    DualArmPickPlaceApproachEndPoseParameters():
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (u_pickobject_gripper_span.base >> (8 * 3)) & 0xFF;
      ...
      offset += this->placeobject_sync.serialize(outbuffer + offset);
      offset += this->place_execution_actor_resting.serialize(outbuffer + offset);
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += this->placeobject_sync.deserialize(inbuffer + offset);
      offset += this->place_execution_actor_resting.deserialize(inbuffer + offset);
    ...
    virtual const char * getType() override { return "process_im_msgs/DualArmPickPlaceApproachEndPoseParameters"; };
    virtual const char * getMD5() override { return "0fdd4d4c1bb43a8a58412c805dd14206"; };
