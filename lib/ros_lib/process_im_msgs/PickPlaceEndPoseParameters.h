#ifndef _ROS_process_im_msgs_PickPlaceEndPoseParameters_h
#define _ROS_process_im_msgs_PickPlaceEndPoseParameters_h
...
namespace process_im_msgs
{
  ...
  class PickPlaceEndPoseParameters : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "process_im_msgs/PickPlaceEndPoseParameters"; };
    virtual const char * getMD5() override { return "f6dd2d0a4494ef200c9a4c9209c5377d"; };
