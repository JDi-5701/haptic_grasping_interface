#ifndef _ROS_process_im_msgs_DualArmAssemblyGroundEndPoseParameters_h
#define _ROS_process_im_msgs_DualArmAssemblyGroundEndPoseParameters_h
...
namespace process_im_msgs
{
  ...
  class DualArmAssemblyGroundEndPoseParameters : public ros::Msg
  {
    public:
      ...
      typedef geometry_msgs::Pose _pickobject_place_approach_type;
      _pickobject_place_approach_type pickobject_place_approach;
    ...
    DualArmAssemblyGroundEndPoseParameters():
      pickobject_grasp_approach(),
      pickobject_grasp(),
      pickobject_place_approach(),
      pickobject_assembly(),
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      offset += this->pickobject_place_approach.serialize(outbuffer + offset);
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += this->pickobject_place_approach.deserialize(inbuffer + offset);
    ...
    virtual const char * getType() override { return "process_im_msgs/DualArmAssemblyGroundEndPoseParameters"; };
    virtual const char * getMD5() override { return "5f61e0451047dcae2bb8d179b88a9af9"; };
