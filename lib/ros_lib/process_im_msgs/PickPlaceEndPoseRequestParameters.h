#ifndef _ROS_process_im_msgs_PickPlaceEndPoseRequestParameters_h
#define _ROS_process_im_msgs_PickPlaceEndPoseRequestParameters_h
...
namespace process_im_msgs
{
  ...
  class PickPlaceEndPoseRequestParameters : public ros::Msg
  {
    public:
    ...
    PickPlaceEndPoseRequestParameters():
    ...
    virtual const char * getType() override { return "process_im_msgs/PickPlaceEndPoseRequestParameters"; };
