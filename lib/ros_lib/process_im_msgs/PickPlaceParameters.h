#ifndef _ROS_process_im_msgs_PickPlaceParameters_h
#define _ROS_process_im_msgs_PickPlaceParameters_h
...
namespace process_im_msgs
{
  ...
  class PickPlaceParameters : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "process_im_msgs/PickPlaceParameters"; };
    virtual const char * getMD5() override { return "1047ffdf888adfb1664e70b213610b69"; };
