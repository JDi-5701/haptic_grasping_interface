#ifndef _ROS_process_im_msgs_NailParameters_h
#define _ROS_process_im_msgs_NailParameters_h
...
namespace process_im_msgs
{
  ...
  class NailParameters : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "process_im_msgs/NailParameters"; };
    virtual const char * getMD5() override { return "a56ef80bee1da561bdccc5ca294ce08d"; };
