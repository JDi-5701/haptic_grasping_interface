#ifndef _ROS_process_im_msgs_DualArmPickPlaceParameters_h
#define _ROS_process_im_msgs_DualArmPickPlaceParameters_h
...
namespace process_im_msgs
{
  ...
  class DualArmPickPlaceParameters : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "process_im_msgs/DualArmPickPlaceParameters"; };
