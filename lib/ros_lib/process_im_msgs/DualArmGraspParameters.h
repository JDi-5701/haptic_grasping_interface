#ifndef _ROS_process_im_msgs_DualArmGraspParameters_h
#define _ROS_process_im_msgs_DualArmGraspParameters_h
...
namespace process_im_msgs
{
  ...
  class DualArmGraspParameters : public ros::Msg
  {
    public:
      ...
      typedef geometry_msgs::Pose _pickobject_resting_type;
      _pickobject_resting_type pickobject_resting;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      offset += this->pickobject_resting.serialize(outbuffer + offset);
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += this->pickobject_resting.deserialize(inbuffer + offset);
    ...
    virtual const char * getType() override { return "process_im_msgs/DualArmGraspParameters"; };
    virtual const char * getMD5() override { return "91387e5e1230f283a454e77f3a073fc2"; };
