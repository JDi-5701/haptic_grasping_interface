#ifndef _ROS_process_im_msgs_DualArmPickPlaceEndPoseParameters_h
#define _ROS_process_im_msgs_DualArmPickPlaceEndPoseParameters_h
...
namespace process_im_msgs
{
  ...
  class DualArmPickPlaceEndPoseParameters : public ros::Msg
  {
    public:
    ...
    DualArmPickPlaceEndPoseParameters():
    ...
    virtual const char * getType() override { return "process_im_msgs/DualArmPickPlaceEndPoseParameters"; };
    virtual const char * getMD5() override { return "7986966db5896a3f909d7c02aed282b7"; };
