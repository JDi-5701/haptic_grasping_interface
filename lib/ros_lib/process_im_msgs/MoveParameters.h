#ifndef _ROS_process_im_msgs_MoveParameters_h
#define _ROS_process_im_msgs_MoveParameters_h
...
namespace process_im_msgs
{
  ...
  class MoveParameters : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "process_im_msgs/MoveParameters"; };
