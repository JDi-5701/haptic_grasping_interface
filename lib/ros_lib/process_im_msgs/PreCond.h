#ifndef _ROS_process_im_msgs_PreCond_h
#define _ROS_process_im_msgs_PreCond_h
...
namespace process_im_msgs
{
  ...
  class PreCond : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "process_im_msgs/PreCond"; };
