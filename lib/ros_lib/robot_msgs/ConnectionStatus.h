#ifndef _ROS_robot_msgs_ConnectionStatus_h
#define _ROS_robot_msgs_ConnectionStatus_h
...
namespace robot_msgs
{
  ...
  class ConnectionStatus : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_msgs/ConnectionStatus"; };
    virtual const char * getMD5() override { return "b35e3ef4907d41dadb506b25e0a7dfa2"; };
