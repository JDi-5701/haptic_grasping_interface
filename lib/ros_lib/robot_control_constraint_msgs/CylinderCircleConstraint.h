#ifndef _ROS_robot_control_constraint_msgs_CylinderCircleConstraint_h
#define _ROS_robot_control_constraint_msgs_CylinderCircleConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class CylinderCircleConstraint : public ros::Msg
  {
    public:
      typedef const char* _id_type;
      _id_type id;
      typedef robot_control_constraint_msgs::Circle _fixed_type;
      _fixed_type fixed;
      typedef robot_control_constraint_msgs::Cylinder _constrained_type;
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/CylinderCircleConstraint"; };
    virtual const char * getMD5() override { return "bb4d375f4792ccf8bbff31bb70c27f37"; };
