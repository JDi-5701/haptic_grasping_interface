#ifndef _ROS_robot_control_constraint_msgs_PointConeConstraint_h
#define _ROS_robot_control_constraint_msgs_PointConeConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PointConeConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PointConeConstraint"; };
    virtual const char * getMD5() override { return "f240e4f503c0b05deeda0f436af070ca"; };
