#ifndef _ROS_robot_control_constraint_msgs_CircleCylinderConstraint_h
#define _ROS_robot_control_constraint_msgs_CircleCylinderConstraint_h

#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
#include "robot_control_constraint_msgs/Cylinder.h"
#include "robot_control_constraint_msgs/Circle.h"

namespace robot_control_constraint_msgs
{

  class CircleCylinderConstraint : public ros::Msg
  {
    public:
      typedef const char* _id_type;
      _id_type id;
      typedef robot_control_constraint_msgs::Cylinder _fixed_type;
      _fixed_type fixed;
      typedef robot_control_constraint_msgs::Circle _constrained_type;
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/CircleCylinderConstraint"; };
    virtual const char * getMD5() override { return "242343410e57d7232eeb992a6ca4fcbd"; };
