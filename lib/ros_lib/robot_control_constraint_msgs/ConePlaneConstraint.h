#ifndef _ROS_robot_control_constraint_msgs_ConePlaneConstraint_h
#define _ROS_robot_control_constraint_msgs_ConePlaneConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class ConePlaneConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/ConePlaneConstraint"; };
    virtual const char * getMD5() override { return "b88f136a73ce33d33b7b7061ee3de5f0"; };
