#ifndef _ROS_robot_control_constraint_msgs_PlaneCylinderConstraint_h
#define _ROS_robot_control_constraint_msgs_PlaneCylinderConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PlaneCylinderConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PlaneCylinderConstraint"; };
    virtual const char * getMD5() override { return "506963f0eed3d10d32cf2330b468b26c"; };
