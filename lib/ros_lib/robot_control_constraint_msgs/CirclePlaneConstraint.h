#ifndef _ROS_robot_control_constraint_msgs_CirclePlaneConstraint_h
#define _ROS_robot_control_constraint_msgs_CirclePlaneConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class CirclePlaneConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/CirclePlaneConstraint"; };
    virtual const char * getMD5() override { return "c228d0bcec91d1f2822a8b13f0e20590"; };
