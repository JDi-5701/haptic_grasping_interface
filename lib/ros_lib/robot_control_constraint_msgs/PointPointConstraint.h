#ifndef _ROS_robot_control_constraint_msgs_PointPointConstraint_h
#define _ROS_robot_control_constraint_msgs_PointPointConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PointPointConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PointPointConstraint"; };
    virtual const char * getMD5() override { return "c1c23bafe9cfe307771a9c69d95bf0b6"; };
