#ifndef _ROS_robot_control_constraint_msgs_ConeConeConstraint_h
#define _ROS_robot_control_constraint_msgs_ConeConeConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class ConeConeConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/ConeConeConstraint"; };
    virtual const char * getMD5() override { return "39eb1a50c7cb6de0b2a6067f43cf0419"; };
