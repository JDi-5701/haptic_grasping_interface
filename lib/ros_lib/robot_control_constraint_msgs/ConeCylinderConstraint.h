#ifndef _ROS_robot_control_constraint_msgs_ConeCylinderConstraint_h
#define _ROS_robot_control_constraint_msgs_ConeCylinderConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class ConeCylinderConstraint : public ros::Msg
  {
    public:
      ...
      _fixed_type fixed;
      typedef robot_control_constraint_msgs::Cone _constrained_type;
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/ConeCylinderConstraint"; };
    virtual const char * getMD5() override { return "dc60dd98c359349c0d0d66acff53401d"; };
