#ifndef _ROS_robot_control_constraint_msgs_PointCylinderConstraint_h
#define _ROS_robot_control_constraint_msgs_PointCylinderConstraint_h
...
#include "robot_control_constraint_msgs/Point.h"

namespace robot_control_constraint_msgs
{

  class PointCylinderConstraint : public ros::Msg
  {
    public:
      ...
      _fixed_type fixed;
      typedef robot_control_constraint_msgs::Point _constrained_type;
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PointCylinderConstraint"; };
    virtual const char * getMD5() override { return "8ec3180e0ad1359515e6b3801983d9c5"; };
