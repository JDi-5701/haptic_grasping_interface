#ifndef _ROS_robot_control_constraint_msgs_PointPlaneConstraint_h
#define _ROS_robot_control_constraint_msgs_PointPlaneConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PointPlaneConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PointPlaneConstraint"; };
    virtual const char * getMD5() override { return "491bfb0f4981fb6527cbe18323743654"; };
