#ifndef _ROS_robot_control_constraint_msgs_LineConeConstraint_h
#define _ROS_robot_control_constraint_msgs_LineConeConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class LineConeConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/LineConeConstraint"; };
    virtual const char * getMD5() override { return "b1da17a8d07de20dbf855e15811c6d4f"; };
