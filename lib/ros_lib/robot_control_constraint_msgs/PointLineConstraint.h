#ifndef _ROS_robot_control_constraint_msgs_PointLineConstraint_h
#define _ROS_robot_control_constraint_msgs_PointLineConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PointLineConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PointLineConstraint"; };
    virtual const char * getMD5() override { return "e68ee1ec3634bc028b5402121cc7dd83"; };
