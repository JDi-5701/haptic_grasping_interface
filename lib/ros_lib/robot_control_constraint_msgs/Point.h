#ifndef _ROS_robot_control_constraint_msgs_Point_h
#define _ROS_robot_control_constraint_msgs_Point_h
...
namespace robot_control_constraint_msgs
{
  ...
  class Point : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/Point"; };
    virtual const char * getMD5() override { return "860f139cd6d3a6428cf6736128f23254"; };
