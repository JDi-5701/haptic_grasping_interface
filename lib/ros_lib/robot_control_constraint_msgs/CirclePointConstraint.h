#ifndef _ROS_robot_control_constraint_msgs_CirclePointConstraint_h
#define _ROS_robot_control_constraint_msgs_CirclePointConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class CirclePointConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/CirclePointConstraint"; };
    virtual const char * getMD5() override { return "57948d76c3a4aed03a58bc7b3dbac361"; };
