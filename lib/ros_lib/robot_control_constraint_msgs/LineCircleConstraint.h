#ifndef _ROS_robot_control_constraint_msgs_LineCircleConstraint_h
#define _ROS_robot_control_constraint_msgs_LineCircleConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class LineCircleConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/LineCircleConstraint"; };
    virtual const char * getMD5() override { return "84bd70a0319b743df95db74416580404"; };
