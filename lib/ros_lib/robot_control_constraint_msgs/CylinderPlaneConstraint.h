#ifndef _ROS_robot_control_constraint_msgs_CylinderPlaneConstraint_h
#define _ROS_robot_control_constraint_msgs_CylinderPlaneConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class CylinderPlaneConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/CylinderPlaneConstraint"; };
    virtual const char * getMD5() override { return "10a7f5bd72554e289460431365196355"; };
