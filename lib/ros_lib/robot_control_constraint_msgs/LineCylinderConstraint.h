#ifndef _ROS_robot_control_constraint_msgs_LineCylinderConstraint_h
#define _ROS_robot_control_constraint_msgs_LineCylinderConstraint_h
...
#include "robot_control_constraint_msgs/Line.h"

namespace robot_control_constraint_msgs
{

  class LineCylinderConstraint : public ros::Msg
  {
    public:
      ...
      _fixed_type fixed;
      typedef robot_control_constraint_msgs::Line _constrained_type;
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/LineCylinderConstraint"; };
    virtual const char * getMD5() override { return "dc67146ae7fb2684f7140ca6a0f8d157"; };
