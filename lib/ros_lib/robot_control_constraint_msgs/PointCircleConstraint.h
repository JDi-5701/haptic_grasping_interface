#ifndef _ROS_robot_control_constraint_msgs_PointCircleConstraint_h
#define _ROS_robot_control_constraint_msgs_PointCircleConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PointCircleConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PointCircleConstraint"; };
    virtual const char * getMD5() override { return "d67ed9c870647198dfb35be1d3289545"; };
