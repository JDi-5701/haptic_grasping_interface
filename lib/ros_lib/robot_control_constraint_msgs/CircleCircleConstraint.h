#ifndef _ROS_robot_control_constraint_msgs_CircleCircleConstraint_h
#define _ROS_robot_control_constraint_msgs_CircleCircleConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class CircleCircleConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/CircleCircleConstraint"; };
    virtual const char * getMD5() override { return "b26ef0a902cc1812e789b33ed0a27ba4"; };
