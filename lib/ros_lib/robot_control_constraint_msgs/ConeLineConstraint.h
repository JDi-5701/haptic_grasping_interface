#ifndef _ROS_robot_control_constraint_msgs_ConeLineConstraint_h
#define _ROS_robot_control_constraint_msgs_ConeLineConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class ConeLineConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/ConeLineConstraint"; };
    virtual const char * getMD5() override { return "53626b1689b3f818a6434f86b5211bca"; };
