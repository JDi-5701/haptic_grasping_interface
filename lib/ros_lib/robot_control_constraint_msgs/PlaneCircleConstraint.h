#ifndef _ROS_robot_control_constraint_msgs_PlaneCircleConstraint_h
#define _ROS_robot_control_constraint_msgs_PlaneCircleConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PlaneCircleConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PlaneCircleConstraint"; };
    virtual const char * getMD5() override { return "d9c65bd6cde2070a9206ce7ebb2ee0c2"; };
