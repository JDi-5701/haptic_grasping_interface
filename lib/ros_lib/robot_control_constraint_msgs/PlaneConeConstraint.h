#ifndef _ROS_robot_control_constraint_msgs_PlaneConeConstraint_h
#define _ROS_robot_control_constraint_msgs_PlaneConeConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PlaneConeConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PlaneConeConstraint"; };
    virtual const char * getMD5() override { return "abf2c777a2e9794ee9f414d35d8d90d4"; };
