#ifndef _ROS_robot_control_constraint_msgs_LinePlaneConstraint_h
#define _ROS_robot_control_constraint_msgs_LinePlaneConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class LinePlaneConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/LinePlaneConstraint"; };
    virtual const char * getMD5() override { return "f059acb96fdf9b748c2cf117cbb42383"; };
