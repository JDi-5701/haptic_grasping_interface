#ifndef _ROS_robot_control_constraint_msgs_Cone_h
#define _ROS_robot_control_constraint_msgs_Cone_h
...
namespace robot_control_constraint_msgs
{
  ...
  class Cone : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/Cone"; };
    virtual const char * getMD5() override { return "103dd195362ea0f63feda588a64bbc0e"; };
