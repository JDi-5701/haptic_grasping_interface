#ifndef _ROS_robot_control_constraint_msgs_ConePointConstraint_h
#define _ROS_robot_control_constraint_msgs_ConePointConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class ConePointConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/ConePointConstraint"; };
    virtual const char * getMD5() override { return "40f0d6f9e12cd28d30d5b34c8109b061"; };
