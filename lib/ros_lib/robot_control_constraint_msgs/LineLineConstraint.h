#ifndef _ROS_robot_control_constraint_msgs_LineLineConstraint_h
#define _ROS_robot_control_constraint_msgs_LineLineConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class LineLineConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/LineLineConstraint"; };
    virtual const char * getMD5() override { return "cf54f835b712b4f6cb4125ff70225d53"; };
