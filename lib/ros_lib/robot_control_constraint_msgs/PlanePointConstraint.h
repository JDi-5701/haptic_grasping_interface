#ifndef _ROS_robot_control_constraint_msgs_PlanePointConstraint_h
#define _ROS_robot_control_constraint_msgs_PlanePointConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PlanePointConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PlanePointConstraint"; };
    virtual const char * getMD5() override { return "00db6a407e4ae60c76a77d78807bb496"; };
