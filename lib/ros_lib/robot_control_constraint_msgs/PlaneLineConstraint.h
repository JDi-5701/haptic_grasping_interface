#ifndef _ROS_robot_control_constraint_msgs_PlaneLineConstraint_h
#define _ROS_robot_control_constraint_msgs_PlaneLineConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class PlaneLineConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/PlaneLineConstraint"; };
    virtual const char * getMD5() override { return "09e5d52ad9af07bc91fba65934076581"; };
