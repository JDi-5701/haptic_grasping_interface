#ifndef _ROS_robot_control_constraint_msgs_CircleConeConstraint_h
#define _ROS_robot_control_constraint_msgs_CircleConeConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class CircleConeConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/CircleConeConstraint"; };
    virtual const char * getMD5() override { return "5b43ebf75f1922d6451457b3d2d18fe3"; };
