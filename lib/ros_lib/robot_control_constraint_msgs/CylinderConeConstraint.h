#ifndef _ROS_robot_control_constraint_msgs_CylinderConeConstraint_h
#define _ROS_robot_control_constraint_msgs_CylinderConeConstraint_h

#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
#include "robot_control_constraint_msgs/Cone.h"
#include "robot_control_constraint_msgs/Cylinder.h"

namespace robot_control_constraint_msgs
{

  class CylinderConeConstraint : public ros::Msg
  {
    public:
      typedef const char* _id_type;
      _id_type id;
      typedef robot_control_constraint_msgs::Cone _fixed_type;
      _fixed_type fixed;
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/CylinderConeConstraint"; };
    virtual const char * getMD5() override { return "415e8600b5cbfe2d73ae54bbd7357850"; };
