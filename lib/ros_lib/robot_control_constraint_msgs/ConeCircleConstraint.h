#ifndef _ROS_robot_control_constraint_msgs_ConeCircleConstraint_h
#define _ROS_robot_control_constraint_msgs_ConeCircleConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class ConeCircleConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/ConeCircleConstraint"; };
    virtual const char * getMD5() override { return "f097d772a0122b7c7a55bf258c253bad"; };
