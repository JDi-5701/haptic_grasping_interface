#ifndef _ROS_robot_control_constraint_msgs_Line_h
#define _ROS_robot_control_constraint_msgs_Line_h
...
namespace robot_control_constraint_msgs
{
  ...
  class Line : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/Line"; };
    virtual const char * getMD5() override { return "ce74788a488397301182a21b6ea14d0d"; };
