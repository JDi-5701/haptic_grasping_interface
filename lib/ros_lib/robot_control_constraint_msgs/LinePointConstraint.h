#ifndef _ROS_robot_control_constraint_msgs_LinePointConstraint_h
#define _ROS_robot_control_constraint_msgs_LinePointConstraint_h
...
namespace robot_control_constraint_msgs
{
  ...
  class LinePointConstraint : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "robot_control_constraint_msgs/LinePointConstraint"; };
    virtual const char * getMD5() override { return "edf5f6326f32af67114464bbedd8d487"; };
