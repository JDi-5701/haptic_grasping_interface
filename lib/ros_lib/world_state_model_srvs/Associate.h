#ifndef _ROS_SERVICE_Associate_h
#define _ROS_SERVICE_Associate_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ASSOCIATE[] = "world_state_model_srvs/Associate";

  class AssociateRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return ASSOCIATE; };
    virtual const char * getMD5() override { return "d0a76c0e6315ade6080d43b42e66fd8b"; };

  };

  class AssociateResponse : public ros::Msg
  {
    public:
  ...
  class Associate {
    public:
    typedef AssociateRequest Request;
    typedef AssociateResponse Response;
  };
