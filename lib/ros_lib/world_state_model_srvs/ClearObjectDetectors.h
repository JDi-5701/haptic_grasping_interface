#ifndef _ROS_SERVICE_ClearObjectDetectors_h
#define _ROS_SERVICE_ClearObjectDetectors_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char CLEAROBJECTDETECTORS[] = "world_state_model_srvs/ClearObjectDetectors";

  class ClearObjectDetectorsRequest : public ros::Msg
  {
    public:

    ClearObjectDetectorsRequest()
    {
    }
    ...
    virtual const char * getType() override { return CLEAROBJECTDETECTORS; };
    virtual const char * getMD5() override { return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class ClearObjectDetectorsResponse : public ros::Msg
  {
    public:
      typedef int32_t _error_type;
      _error_type error;

    ClearObjectDetectorsResponse():
      error(0)
    {
    }
  ...
  class ClearObjectDetectors {
    public:
    typedef ClearObjectDetectorsRequest Request;
    typedef ClearObjectDetectorsResponse Response;
  };
