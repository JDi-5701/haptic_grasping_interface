#ifndef _ROS_SERVICE_RemoveObjectDetector_h
#define _ROS_SERVICE_RemoveObjectDetector_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char REMOVEOBJECTDETECTOR[] = "world_state_model_srvs/RemoveObjectDetector";

  class RemoveObjectDetectorRequest : public ros::Msg
  {
    public:
      typedef const char* _topicName_type;
      _topicName_type topicName;

    RemoveObjectDetectorRequest():
      topicName("")
    {
    }
    ...
    virtual const char * getType() override { return REMOVEOBJECTDETECTOR; };
    virtual const char * getMD5() override { return "74b3306276d42621c8d9905fba018178"; };

  };

  class RemoveObjectDetectorResponse : public ros::Msg
  {
    public:
      typedef int32_t _error_type;
      _error_type error;

    RemoveObjectDetectorResponse():
      error(0)
    {
    }
  ...
  class RemoveObjectDetector {
    public:
    typedef RemoveObjectDetectorRequest Request;
    typedef RemoveObjectDetectorResponse Response;
  };
