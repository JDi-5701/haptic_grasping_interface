#ifndef _ROS_process_msgs_Individual_h
#define _ROS_process_msgs_Individual_h
...
namespace process_msgs
{
  ...
  class Individual : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "process_msgs/Individual"; };
    virtual const char * getMD5() override { return "0c29326ff7449a2bbf7b1afd52781338"; };
