#ifndef _ROS_process_msgs_Precondition_h
#define _ROS_process_msgs_Precondition_h
...
namespace process_msgs
{
  ...
  class Precondition : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "process_msgs/Precondition"; };
