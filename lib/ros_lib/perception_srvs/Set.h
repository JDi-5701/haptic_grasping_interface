#ifndef _ROS_SERVICE_Set_h
#define _ROS_SERVICE_Set_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
#include "perception_msgs/ObjRecConfig.h"

namespace perception_srvs
{

static const char SET[] = "perception_srvs/Set";

  class SetRequest : public ros::Msg
  {
    public:
      uint32_t objects_length;
      typedef perception_msgs::ObjRecConfig _objects_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(objects_lengthT > objects_length)
        this->objects = (perception_msgs::ObjRecConfig*)realloc(this->objects, objects_lengthT * sizeof(perception_msgs::ObjRecConfig));
      objects_length = objects_lengthT;
      for( uint32_t i = 0; i < objects_length; i++){
      offset += this->st_objects.deserialize(inbuffer + offset);
        memcpy( &(this->objects[i]), &(this->st_objects), sizeof(perception_msgs::ObjRecConfig));
      }
     return offset;
    }

    virtual const char * getType() override { return SET; };
    virtual const char * getMD5() override { return "5ffbe61dd3762b6e18724ad99f6013cd"; };

  };

  class SetResponse : public ros::Msg
  {
    public:
