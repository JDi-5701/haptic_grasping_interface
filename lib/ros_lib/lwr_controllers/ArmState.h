...
namespace lwr_controllers
{
  ...
  class ArmState : public ros::Msg
  {
    ...
    ArmState():
      ...
      est_ext_torques_length(0), st_est_ext_torques(), est_ext_torques(nullptr),
      est_ee_wrench(),
      est_ee_wrench_base()
    {
    }
    ...
    virtual const char * getType() override { return "lwr_controllers/ArmState"; };
    virtual const char * getMD5() override { return "1ec4005eded14deb32698c63aa479d03"; };
