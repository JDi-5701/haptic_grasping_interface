...
namespace lwr_controllers
{
  ...
  class CartesianImpedancePoint : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "lwr_controllers/CartesianImpedancePoint"; };
    virtual const char * getMD5() override { return "71b8c728a99ddb73ba603776d4733a5f"; };
